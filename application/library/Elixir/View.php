...
class Elixir_View {
	 ...
	 * you must call [self::set_filename].
	 *
	 *     $view = self::factory($file);
	 *
	...
	/**
	 * Sets a global variable, similar to [self::set], except that the
	 ...
	 *     self::set_global(array('food' => 'bread', 'beverage' => 'water'));
	 *
	...
	/**
	 * Assigns a global variable by reference, similar to [self::bind], except
	 * that the variable will be accessible to all views.
	 *
	 *     self::bind_global($key, $value);
	 *
	 ...
	 * always only be created using [self::factory].
	 *
	 *     $view = new View($file);
	 *
	 * @param   string  $file   view filename
	 * @param   array   $data   array of values
	 * @uses    self::set_filename
	 */
