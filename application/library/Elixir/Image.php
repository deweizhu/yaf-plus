	...
	public function resize($width = NULL, $height = NULL, $master = NULL)
	{
         if($master == Image::AUTO) {
            ...
            if($width > $this->width && $height > $this->height) {
                ...
                $xratio = ($width == 0) ? 1 : $this->width / $width;
                $yratio = ($height == 0) ? 1 : $this->height / $height;
                if ($xratio > $yratio) {
                    $width = round ( $this->width / $xratio );
                    $height = round ( $this->height / $xratio );
                } else {
                    $width = round ( $this->width / $yratio );
                    $height = round ( $this->height / $yratio );
                }
            }
            /*}}} */
        }
