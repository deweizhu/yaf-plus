...
class Database_Query_Builder_Select extends Database_Query_Builder_Where
{
    ...
    {
        $this->_join[] = $this->_last_join = new Database_Query_Builder_Join($table, 'LEFT');
        return $this;
    }

    public function rightjoin($table)
    {
        $this->_join[] = $this->_last_join = new Database_Query_Builder_Join($table, 'RIGHT');
        return $this;
    }

    public function innerjoin($table)
    {
        $this->_join[] = $this->_last_join = new Database_Query_Builder_Join($table, 'INNER');
        return $this;
    }
