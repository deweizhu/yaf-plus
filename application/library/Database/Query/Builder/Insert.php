...
class Database_Query_Builder_Insert extends Database_Query_Builder
{
    ...
    {
        if (!is_string($table))
            throw new Elixir_Exception('INSERT INTO syntax does not allow table aliasing');
    ...
    public function values(array $values)
    {
        if (!is_array($this->_values)) {
            throw new Elixir_Exception('INSERT INTO ... SELECT statements cannot be combined with INSERT INTO ... VALUES');
        }
    ...
    public function select(Database_Query $query)
    {
        if ($query->type() !== Database::SELECT) {
            throw new Elixir_Exception('Only SELECT queries can be combined with INSERT queries');
        }
